...
public class AlertMessageFragment extends Fragment {
    ...
    public static AlertMessageFragment getInstance(ArrayList<KeyValuePair> keyValuePairs, String title, String message, PaymentModel mPaymentModel, boolean isHappy, boolean isBackButtonEnable, String from){
