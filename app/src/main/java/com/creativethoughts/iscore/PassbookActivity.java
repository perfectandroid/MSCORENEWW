...
public class PassbookActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        try {
            PassbookActivity.ViewPagerAdapter adapter = new PassbookActivity.ViewPagerAdapter(getSupportFragmentManager());
            adapter.addFragment(new HomeFragment(), "Passbook");
