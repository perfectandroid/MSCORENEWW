...
public class NotificationPostingActivity extends AppCompatActivity {
    ...
    public void getNotice(){
        ...
        if (NetworkUtil.isOnline()) {
            try{
                progressDialog = new ProgressDialog(NotificationPostingActivity.this, R.style.Progress);
                    ...
                    @Override public void onResponse(Call<String> call, retrofit2.Response<String> response) {
                        try {
                            ...
                            if(jObject.getString("StatusCode").equals("0")) {
                                ...
                                if(jarray.length()!=0){
                                    GridLayoutManager lLayout = new GridLayoutManager(NotificationPostingActivity.this, 1);
                                    rv_intimation.setLayoutManager(lLayout);
                                    rv_intimation.setHasFixedSize(true);
                                    IntimationAdapter1 adapter = new IntimationAdapter1(NotificationPostingActivity.this, jarray);
                                    rv_intimation.setAdapter(adapter);
                                }else {
                                    ll_intimation.setVisibility(View.GONE);
                                    android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(NotificationPostingActivity.this);
...
//                                builder.setMessage("No data found.")
            ...
            DialogUtil.showAlert(NotificationPostingActivity.this,
        ...
        getView().setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (event.getAction() == KeyEvent.ACTION_UP && keyCode == KeyEvent.KEYCODE_BACK) {
                    ...
                    Intent i = new Intent(NotificationPostingActivity.this,HomeActivity.class);
                    startActivity(i);
                    getActivity().finish();
                    return true;
                }
