...
import com.creativethoughts.iscore.PassbookTranscationDetailsActivity;
...
public class PassbookTranscationListAdapter extends RecyclerView.Adapter {
    JSONArray jsonArray;
    JSONObject jsonObject=null;
    Context context;
    String SubModule;

    public PassbookTranscationListAdapter(Context context, JSONArray jsonArray, String SubModule) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.passbook_list_row, parent, false);
            ...
            if (holder instanceof MainViewHolder) {
                ...
                ((MainViewHolder) holder).lnLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            jsonObject = jsonArray.getJSONObject(position);
                            Intent i = new Intent(context, PassbookTranscationDetailsActivity.class);
