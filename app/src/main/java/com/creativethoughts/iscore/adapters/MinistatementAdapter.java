...
public class MinistatementAdapter  extends ArrayAdapter<Transaction> {
    Context mCtx;
    int listLayoutRes;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(transtype.equals("C"))
        {
            ...
            if (transaction.isNew) {
                ...
                txtTransactionAmount.setTypeface(txtTransactiontype.getTypeface(), Typeface.NORMAL);
            } else {
                txtTransactiontype.setTypeface(txtTransactiontype.getTypeface(), Typeface.NORMAL);
            }
        }
        ...
        txtTransactionAmount.setText("\u20B9 "+ NumberFormat.getNumberInstance(Locale.US).format(num));
