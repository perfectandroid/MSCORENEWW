...
public class IntimationAdapter1 extends RecyclerView.Adapter {
    JSONArray jsonArray;
    JSONObject jsonObject=null;
    Context context;

    public IntimationAdapter1(Context context, JSONArray jsonArray) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.activity_intimation_details1, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        try {
            ...
            if (holder instanceof MainViewHolder) {
                ...
                double num =Double.parseDouble(jsonObject.getString("DueAmount"));
                ((MainViewHolder)holder).tvDueAmt.setText("₹ "+ CommonUtilities.getDecimelFormate(num));
            }
