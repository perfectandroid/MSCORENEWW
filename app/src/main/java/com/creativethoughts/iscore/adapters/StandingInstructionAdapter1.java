...
public class StandingInstructionAdapter1 extends RecyclerView.Adapter {
    JSONArray jsonArray;
    JSONObject jsonObject=null;
    Context context;

    public StandingInstructionAdapter1(Context context, JSONArray jsonArray) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.activity_standinginstrctn1, parent, false);
            ...
            if (holder instanceof MainViewHolder) {
             ...
             /*   if(!jsonObject.getString("Date").isEmpty()) {
              ...
              //  ((MainViewHolder)holder).tvSLNO.setText(""+(position+1));
                ...
                ((MainViewHolder)holder).tvamount.setText("₹ "+ CommonUtilities.getDecimelFormate(Double.parseDouble(jsonObject.getString("Amount"))));
            }
